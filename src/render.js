...
export function renderJoke(currentJoke, id) {
  let jokeHTML = `<div id=${id} class="saved-joke">
            <p class="saved-joke__text">${currentJoke}</p>
            <button class="saved-joke__button" onclick="deleteJoke(${id})">
            <svg
